"""
Body-Worn Camera Audio Processing Pipeline
Converts MP4 bodycam footage to labeled transcripts with speaker diarization

Requirements:
pip install moviepy torch transformers pyannote.audio accelerate librosa soundfile
pip install --upgrade pyannote.audio

Note: You'll need a Hugging Face token with access to pyannote models.
